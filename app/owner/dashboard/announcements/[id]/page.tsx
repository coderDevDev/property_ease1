...
export default function OwnerAnnouncementDetailsPage() {
    ...
    const loadAnnouncement = async () => {
      ...
      try {
        ...
        if (result.success && result.data) {
          ...
          router.push('/owner/dashboard/announcements');
        }
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-slate-50 to-blue-100 p-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <Button
              onClick={() => router.push('/owner/dashboard/announcements')}>
                      ...
                      announcement.target_users_data && (
                        <div className="space-y-2">
                          <Label className="text-sm font-medium text-gray-600">
                            Targeted Users (
                            {announcement.target_users_data.length})
                          </Label>
                          <div className="space-y-2">
