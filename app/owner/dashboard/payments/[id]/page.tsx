...
export default function OwnerPaymentDetailsPage() {
  ...
  const handleMarkAsPaid = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Reload payment
        const updatedResult = await PaymentsAPI.getPayment(paymentId);
        if (updatedResult.success && updatedResult.data) {
          setPayment(updatedResult.data);
        }
      } else {
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-slate-50 to-blue-100 p-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <Button onClick={() => router.push('/owner/dashboard/payments')}>
              Back to Payments
            </Button>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="flex items-center gap-4">
            <Button
              variant="ghost"
              onClick={() => router.push('/owner/dashboard/payments')}
